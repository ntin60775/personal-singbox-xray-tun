...
DESKTOP_ENTRY_PATH="${APPLICATIONS_DIR}/personal-singbox-xray-tun.desktop"
...
Version=1.0
Type=Application
Name=Subvost Xray TUN GUI (Personal)
Comment=Запуск локального GUI для управления туннелем
Exec=/usr/bin/env python3 -c "import os, sys; os.execv(sys.argv[1], [sys.argv[1], '--force-restart-backend'])" "${LAUNCHER_PATH}"
