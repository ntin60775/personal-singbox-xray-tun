...
- task-centric карточка и план созданы в `knowledge/tasks/TASK-2026-0005-project-structure-cleanup/`.
...
- исходный заголовок: `Приведение структуры bundle к управляемому layout`
