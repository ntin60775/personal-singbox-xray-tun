...
| `TASK-2026-0058` | `—` | `заморожена` | `высокий` | `main` | `archive/windows-port/` | Довести Windows 8.1 порт до проверенной поставки с нативным Windows UI, build scripts, runtime hardening и beginner README — ЗАМОРОЖЕНО, код в archive/windows-port/ |
...
| `TASK-2026-0058.4` | `TASK-2026-0058` | `заморожена` | `высокий` | `main` | `archive/windows-port/` | Живой Windows 8.1 smoke, beginner README, troubleshooting и handoff-комплект — ЗАМОРОЖЕНО |
...
| `TASK-2026-0060` | `—` | `завершена` | `средний` | `task/task-2026-0060-project-local-skills-ignore-and-kimi-review` | `knowledge/tasks/TASK-2026-0060-project-local-skills-ignore-and-kimi-review/` | Исключить project-local навыки из Git и использовать Kimi CLI как консультационный gate для дизайн-ревью |
| `TASK-2026-0061` | `—` | `реализация` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0061-routes-direct-report-ui/` | Добавить вкладку Маршруты с read-only отчётом Прямые маршруты по template, routing-профилю, runtime и конфликтам |
| `TASK-2026-0062` | `—` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0062-orphaned-state-run-script-fix/` | Исправить run-скрипт: orphaned state текущей установки должен автоматически перезаписываться при запуске |
| `TASK-2026-0063` | `—` | `завершена` | `высокий` | `task/task-2026-0064-fix-install-id-ownership` | `knowledge/tasks/TASK-2026-0063-fix-install-id-ownership/` | Исправить создание `.subvost/install-id` так, чтобы файл не оставался принадлежать root при запуске от sudo/pkexec |
| `TASK-2026-0064` | `—` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0064-universal-tui-frontend/` | Универсальный TUI-фронт для любого DE: XFCE, KDE, i3 и прочих Debian 12/13-based дистрибутивов |
| `TASK-2026-0064.1` | `TASK-2026-0064` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0064-universal-tui-frontend/subtasks/TASK-2026-0064.1-tui-functional-gap-audit/` | Аудит недостающего функционала TUI: сравнение со старым Web-GUI + GTK4 native shell |
| `TASK-2026-0064.2` | `TASK-2026-0064` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0064-universal-tui-frontend/subtasks/TASK-2026-0064.2-p0-critical-functions/` | Реализация P0-критичных функций: активация узла, импорт подписки, импорт ссылок |
...
| `TASK-2026-0066` | `—` | `завершена` | `средний` | `main` | `knowledge/tasks/TASK-2026-0066-ddd-refactoring/` | DDD-рефакторинг архитектуры: доменные сущности, репозитории, use cases, разделение слоёв — ВСЕ 7 ФАЗ ЗАВЕРШЕНЫ |
| `TASK-2026-0066.1` | `TASK-2026-0066` | `завершена` | `средний` | `main` | `knowledge/tasks/TASK-2026-0066-ddd-refactoring/` | Фаза 1: Доменные сущности, value objects, фабрики, события |
| `TASK-2026-0066.2` | `TASK-2026-0066` | `завершена` | `средний` | `main` | `knowledge/tasks/TASK-2026-0066-ddd-refactoring/` | Фаза 2: Репозитории, Unit of Work, миграция вызовов |
| `TASK-2026-0066.3` | `TASK-2026-0066` | `завершена` | `средний` | `main` | `knowledge/tasks/TASK-2026-0066-ddd-refactoring/` | Фаза 3: Use Cases, Ports, Adapters |
| `TASK-2026-0066.4` | `TASK-2026-0066` | `завершена` | `средний` | `main` | `knowledge/tasks/TASK-2026-0066-ddd-refactoring/` | Фаза 4: ViewModel, отделение presentation |
...
| `TASK-2026-0067` | `—` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Декомпозиция God Object: 6 прямых вызовов заменены на адаптеры/репозитории, ViewModel в TUI — ЗАВЕРШЕНО |
| `TASK-2026-0067.1` | `TASK-2026-0067` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Шаг 1: StatusViewModel в tui_app.py |
| `TASK-2026-0067.2` | `TASK-2026-0067` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Шаг 2: SystemNetworkAdapter — ping |
| `TASK-2026-0067.3` | `TASK-2026-0067` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Шаг 3: ShellRuntimeAdapter — start/stop/diag |
| `TASK-2026-0067.4` | `TASK-2026-0067` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Шаг 4: Репозитории — Store CRUD |
| `TASK-2026-0067.5` | `TASK-2026-0067` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Шаг 5: Оставшиеся методы |
| `TASK-2026-0067.6` | `TASK-2026-0067` | `завершена` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0067-decompose-god-object/` | Шаг 6: Чистка и финальный suite |