...
- После фиксации результата контур `TASK-2026-0053.6` сохранён как резервный `GTK4`-вариант: дальнейший полный редизайн вынесен в отдельную задачу `TASK-2026-0054`, чтобы не смешивать fallback и новую UI-гипотезу.
...
Подзадача больше не является активным направлением развития: до отдельного решения о возврате к этому варианту она хранится как fallback-кандидат, а новый редизайн развивается отдельно в `TASK-2026-0054`.
