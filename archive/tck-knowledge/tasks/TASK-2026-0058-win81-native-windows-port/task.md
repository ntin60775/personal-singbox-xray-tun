...
| Человекочитаемое описание | `Довести Windows 8.1 порт до проверенной поставки с нативным Windows UI, build scripts, runtime hardening и beginner README` |
| Статус | `заморожена` |
| Приоритет | `высокий` |
| Ответственный | `Codex` |
| Ветка | `archive/windows-port/` |
