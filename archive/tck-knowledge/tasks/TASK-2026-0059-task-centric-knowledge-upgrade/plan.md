...
- создать `task.md` и `plan.md` для `TASK-2026-0059`;
...
- `python3 ~/.agents/skills/markdown-localization-guard/scripts/markdown_localization_guard.py knowledge/tasks/registry.md knowledge/tasks/TASK-2026-0059-task-centric-knowledge-upgrade/task.md knowledge/tasks/TASK-2026-0059-task-centric-knowledge-upgrade/plan.md AGENTS.md knowledge/tasks/_templates/sdd.md`
...
- [x] Открыть новый task-контур `TASK-2026-0059` и синхронизировать ветку задачи.
