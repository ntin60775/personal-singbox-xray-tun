...
| `TASK-2026-0053.6` | `TASK-2026-0053` | `на проверке` | `высокий` | `topic/gtk4-native-ui-spike` | `knowledge/tasks/TASK-2026-0053-gtk4-native-ui-spike/subtasks/TASK-2026-0053.6-gtk4-compact-ux-defect-pass/` | Компактный UX-pass для GTK4 shell расширен: `Dashboard` получил master-`CTA` и старт по последнему выбранному узлу, UI локализован, диагностика вынесена с главного экрана; остаётся живой smoke |
