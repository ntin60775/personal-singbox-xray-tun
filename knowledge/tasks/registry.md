...
| `TASK-2026-0054` | `—` | `на проверке` | `высокий` | `task/task-2026-0054-full-ui-redesign` | `knowledge/tasks/TASK-2026-0054-full-ui-redesign/` | Полированный `GTK4` layout под `1280×960`: полноформатная sidebar, status-line, широкий экран подписок и раздельные `Сводка / Журнал`; дальше нужна контрольная проверка против `TASK-2026-0053.6` |
