...
| `TASK-2026-0054` | `—` | `на проверке` | `высокий` | `task/task-2026-0054-full-ui-redesign` | `knowledge/tasks/TASK-2026-0054-full-ui-redesign/` | Полированный `GTK4` layout под фиксированное `1280×960`: `HeaderBar + StackSwitcher`, без sidebar и banner, со статусами внутри `Подключения`; дальше нужна контрольная проверка против `TASK-2026-0053.6` |
