...
| `TASK-2026-0053.6` | `TASK-2026-0053` | `готова к работе` | `высокий` | `topic/gtk4-native-ui-spike` | `knowledge/tasks/TASK-2026-0053-gtk4-native-ui-spike/subtasks/TASK-2026-0053.6-gtk4-compact-ux-defect-pass/` | Восстановленная подзадача после архивного GTK smoke: компактный проход по геометрии, тёмному контракту и честному `dark-only` shell |
