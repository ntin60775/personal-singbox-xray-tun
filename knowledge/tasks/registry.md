...
| `TASK-2026-0053.6` | `TASK-2026-0053` | `на проверке` | `высокий` | `topic/gtk4-native-ui-spike` | `knowledge/tasks/TASK-2026-0053-gtk4-native-ui-spike/subtasks/TASK-2026-0053.6-gtk4-compact-ux-defect-pass/` | Компактный UX-pass для GTK4 shell выполнен; остаётся живой smoke geometry, resize/maximize и новых тёмных экранов |
