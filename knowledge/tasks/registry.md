...
| `TASK-2026-0060` | `—` | `на проверке` | `средний` | `task/task-2026-0060-project-local-skills-ignore-and-kimi-review` | `knowledge/tasks/TASK-2026-0060-project-local-skills-ignore-and-kimi-review/` | Исключить project-local навыки из Git и использовать Kimi CLI как консультационный gate для дизайн-ревью |
