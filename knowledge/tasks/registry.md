...
| `TASK-2026-0049` | `—` | `на проверке` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0049-gui-launcher-auto-port-fallback/` | Добавить auto-fallback GUI-порта, чтобы repo launcher не конфликтовал с работающим production GUI |
...
| `TASK-2026-0058` | `—` | `в работе` | `высокий` | `task/task-2026-0058-win81-native-windows-port` | `knowledge/tasks/TASK-2026-0058-win81-native-windows-port/` | Довести Windows 8.1 порт до проверенной поставки с нативным Windows UI, build scripts, runtime hardening и beginner README |
...
| `TASK-2026-0058.2` | `TASK-2026-0058` | `готова к работе` | `высокий` | `task/task-2026-0058-win81-native-windows-port` | `knowledge/tasks/TASK-2026-0058-win81-native-windows-port/subtasks/TASK-2026-0058.2-native-windows-ui-shell/` | Нативный Windows UI без браузера: выбор стека, shell-контракт и первый рабочий vertical slice |
| `TASK-2026-0058.3` | `TASK-2026-0058` | `готова к работе` | `высокий` | `task/task-2026-0058-win81-native-windows-port` | `knowledge/tasks/TASK-2026-0058-win81-native-windows-port/subtasks/TASK-2026-0058.3-windows-runtime-routing-hardening/` | Hardening Windows runtime: маршруты, state/log paths, кодировки, stale adapter и recovery |
| `TASK-2026-0058.4` | `TASK-2026-0058` | `черновик` | `высокий` | `task/task-2026-0058-win81-native-windows-port` | `knowledge/tasks/TASK-2026-0058-win81-native-windows-port/subtasks/TASK-2026-0058.4-win81-verification-and-user-docs/` | Живой Windows 8.1 smoke, beginner README, troubleshooting и handoff-комплект |
