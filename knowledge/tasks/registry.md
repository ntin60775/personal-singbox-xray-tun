...
| `TASK-2026-0058` | `—` | `ждёт пользователя` | `высокий` | `task/task-2026-0058-win81-native-windows-port` | `knowledge/tasks/TASK-2026-0058-win81-native-windows-port/` | Довести Windows 8.1 порт до проверенной поставки с нативным Windows UI, build scripts, runtime hardening и beginner README |
...
| `TASK-2026-0058.4` | `TASK-2026-0058` | `ждёт пользователя` | `высокий` | `task/task-2026-0058-win81-native-windows-port` | `knowledge/tasks/TASK-2026-0058-win81-native-windows-port/subtasks/TASK-2026-0058.4-win81-verification-and-user-docs/` | Живой Windows 8.1 smoke, beginner README, troubleshooting и handoff-комплект |
