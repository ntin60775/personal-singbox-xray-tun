...
| `TASK-2026-0041` | `—` | `ждёт пользователя` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0041-public-repo-preparation/` | Подготовить репозиторий к публичной публикации и очистить `HEAD` и историю Git от приватных артефактов |
