...
| Человекочитаемое описание | `Компактный GTK4 UX-pass заморожен как fallback-кандидат: `Dashboard` получил master-`CTA`, UI локализован, а живой smoke остаётся отдельной проверкой возврата` |
| Статус | `на проверке` |
| Приоритет | `высокий` |
| Ответственный | `Codex` |
| Ветка | `main` |
