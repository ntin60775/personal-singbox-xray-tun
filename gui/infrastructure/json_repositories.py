...
def _routing_profile_to_store_dict(rp: RoutingProfile) -> dict[str, Any]:
    ...
    return {
        ...
        "raw_payload": rp.raw_payload,
        "domestic_dns_domain": rp.domestic_dns_domain,
        "domestic_dns_ip": rp.domestic_dns_ip,
        "domestic_dns_type": rp.domestic_dns_type,
        "remote_dns_domain": rp.remote_dns_domain,
        "remote_dns_ip": rp.remote_dns_ip,
        "remote_dns_type": rp.remote_dns_type,
        "fake_dns": rp.fake_dns,
        "last_updated": rp.last_updated,
        "supported_entry_count": rp.supported_entry_count,
        "stored_only_fields": rp.stored_only_fields,
        "ignored_fields": rp.ignored_fields,
        "unknown_fields": rp.unknown_fields,
    }
