...
class GuiServerRuntimeSelectionTests(unittest.TestCase):
    ...
    def test_main_gui_asset_contains_operational_controls(self) -> None:
        ...
        self.assertIn('id="view-subscriptions"', html)
        ...
        self.assertIn('data-view-nav="subscriptions"', html)
        ...
        self.assertIn('id="nav-subscriptions-meta"', html)
        self.assertIn('id="nav-routes-meta"', html)
        self.assertIn('id="nav-logs-meta"', html)
        self.assertIn('id="nav-settings-meta"', html)
        connection_view = html.split('id="view-connection"', 1)[1].split('id="view-subscriptions"', 1)[0]
        self.assertNotIn('id="panel-subscriptions"', connection_view)
