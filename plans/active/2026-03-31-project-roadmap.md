...
- deep link и consumer-oriented onboarding поверх новой модели ещё не реализованы.
...
Этот план тоже остаётся в `plans/drafts/`, но теперь его зависимость от data/model слоя закрыта и основное ограничение — отсутствие отдельной desktop integration ветки:
...
- после фиксации `GTK`-контракта переходить к consumer UX и deep link.
